...
pub mod app {
    ...
    #[link_section = ".trap"]
    unsafe extern "riscv-interrupt-m" fn GPIO() {
        use rtic::export::mcause;
        use rtic::export::interrupt;
        let interrupt_id: usize = mcause::read().code();
        let intr = &*rtic::export::INTERRUPT_CORE0::PTR;
        let mepc = rtic::export::mepc::read();
    ...
    #[link_section = ".trap"]
    unsafe extern "riscv-interrupt-m" fn FROM_CPU_INTR0() {
        use rtic::export::mcause;
        use rtic::export::interrupt;
        let interrupt_id: usize = mcause::read().code();
        let intr = &*rtic::export::INTERRUPT_CORE0::PTR;
    ...
    #[link_section = ".trap"]
    unsafe extern "riscv-interrupt-m" fn FROM_CPU_INTR1() {
        use rtic::export::mcause;
        use rtic::export::interrupt;
        let interrupt_id: usize = mcause::read().code();
        let intr = &*rtic::export::INTERRUPT_CORE0::PTR;
